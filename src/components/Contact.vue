...
<template>
  ...
  >
    <section class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        <div class="mb-4">
          <h2 class="text-lg text-teal-500 mb-2 tracking-wider">Contact</h2>
      ...
      <Card class="bg-muted/60 dark:bg-card">
        <CardHeader class="text-teal-500 text-2xl"> </CardHeader>
        <CardContent>
          <form
          ...
          >
            ...
            <Button class="mt-4 bg-teal-500">Send message</Button>
          </form>
        </CardContent>
